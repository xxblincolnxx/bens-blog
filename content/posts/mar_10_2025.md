...
This is by no means the end of the work on this topic. I'd also eventually like to enable social auth, aka "Login through Google" etc. Then there also needs to be some kind of Role Based Access Control (RBAC) to guard certain endpoints.
